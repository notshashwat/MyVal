...
if(checked.value=='Fixed'){ 
    ...
    let FD = fd_fixed(fdprincipalamt.value,fdIntRate.value,DurationSel,tenureFD.value);
...
let FD = fd_comp(fdprincipalamt.value,fdIntRate.value,tenureFD.value,DurationSel);
FDres.value = FD;
}
